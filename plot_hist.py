    ...
    with open(file) as json_file:
        ...
        for entry in data:
            ...
            try:
                ...
                flag = " " if (iso2 == 'NONE') else '<img src=\\"flags/%s.png\\" class=\\"img-thumbnail\\" style=\\"border:1px solid black;\\" alt=\\"link\\" height=20px>' % iso2.lower()
        ...
        if (continent != "Trivia"): 
            ...
            for aggregate_name in aggregate_dists:
                ...
                try:
                    ...
                    flag = " " if (iso2.lower() == 'none') else '<img src=\\"flags/%s.png\\" style=\\"border:1px solid black;\\" class=\\"img-thumbnail\\" alt=\\"link\\" height=20px>' % iso2
                    bigflag = " " if (iso2.lower() == 'none') else '<img src="flags/%s.png" style="border:1px solid black;display:block;margin:0 auto" class="img-thumbnail" height=40px>' % iso2.lower()
                    if (aggregate_name in admin_to_country):
